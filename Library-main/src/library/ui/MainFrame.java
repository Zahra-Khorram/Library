...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        readerPanel = new JPanel();  // اضافه شد
    ...
    private void showBookMenu() {
        ...
        readBookBtn.addActionListener(e -> openBook(false));
        buttonPanel.add(readBookBtn);

        JButton editBookBtn = new JButton("Edit Book");
        editBookBtn.addActionListener(e -> openBook(true));
        buttonPanel.add(editBookBtn);

        int lines = service.countLines(selectedBook);
        JLabel lineCountLabel = new JLabel("Number of lines: " + lines);
    ...
    private void saveMetadata(ActionEvent e) {
        try {
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(this,
                        "An Error occurred in saving book info!",
                        "Error!",
    ...
    private void openBook(boolean editable) {
        ...
        if (pages != null && !pages.isEmpty()) {
            ...
            pageArea.setText("Error getting book pages.");
        }
